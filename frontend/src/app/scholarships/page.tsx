...
export default function ScholarshipsDirectoryPage() {
  ...
  return (
    <div className="h-[calc(100dvh-4.25rem)] flex flex-col max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 overflow-hidden w-full">
      {/* Top Controls Toolbar Strip (Heading removed to maximize visible cards area) */}
      <div className="shrink-0 flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5 bg-white p-2.5 rounded-2xl border-2 border-black shadow-neo-sm mb-3">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-xl border-2 border-black bg-[#FAF7F2] pl-9 pr-3 py-1.5 text-xs font-bold text-black placeholder:text-neutral-500 focus:outline-none focus:bg-white transition-colors"
          />
        </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          <div className="flex items-center gap-1.5">
            ...
            <select
              ...
              className="rounded-xl border-2 border-black bg-[#FAF7F2] px-2.5 py-1.5 text-xs font-black text-black cursor-pointer focus:outline-none"
            >
          ...
          <Button
            ...
            className="text-xs py-1.5 px-3 shadow-neo-sm hover:shadow-neo shrink-0"
          >
            <Download className="mr-1.5 h-3.5 w-3.5 stroke-[2.5]" />
            <span className="hidden sm:inline">Export CSV</span> ({filteredScholarships.length})
          </Button>
          ...
          <Button
            ...
            className="lg:hidden text-xs py-1.5 px-3 shadow-neo-sm shrink-0"
          >
      ...
      <div className="flex-1 flex gap-5 min-h-0 overflow-hidden">
        {/* Left Filter Sidebar (Compact, no-scrollbar) */}
        <FilterSidebar
          filters={filters}
        ...
        <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
          ...
          {/* Cards Scroll Container: ONLY this area scrolls, with no visible scrollbar */}
          <div className="flex-1 overflow-y-auto min-h-0 pr-1 pb-4 no-scrollbar">
