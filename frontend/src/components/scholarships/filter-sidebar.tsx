    ...
    <>
      ...
      {isOpenMobile && (
        <div className="fixed inset-0 z-50 flex lg:hidden bg-black/60 backdrop-blur-xs">
          <div className="relative ml-auto h-full w-full max-w-xs bg-white p-6 shadow-2xl overflow-y-auto no-scrollbar border-l-3 border-black animate-in slide-in-from-right duration-200">
            <button
              onClick={onCloseMobile}
              className="absolute right-4 top-4 flex h-8 w-8 items-center justify-center rounded-lg border-2 border-black bg-white shadow-neo-sm"
            >
